...
const Firstpage = () => {
    return (
        <div className="h-screen flex justify-center items-center w-full flex-col gap-4 md:p-0 p-8">
            <div className='absolute top-0 w-full h-full flex items-center justify-center z-0 right-24'>
                <Globe large={true} start={true} />
            </div>
            <div className='bg-slate-50 shadow-2xl mb-8 md:mb-0 rounded-3xl p-6 gap-1 flex flex-col z-10 md:w-3/12 items-center'>
