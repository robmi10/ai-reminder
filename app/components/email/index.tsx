...
const EmailTemplate: React.FC<EmailTemplateProps> = ({ reminder, dueDate }) => {
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', color: '#333' }}>
            ...
            <a href="https://www.aireminder.xyz/" style={{ display: 'inline-block', background: '#4A90E2', color: '#ffffff', padding: '10px 20px', textDecoration: 'none', borderRadius: '5px', fontWeight: 'bold' }}>View Task</a>
